    ...
    cooldown.prototype.onAction = function(){
        ...
        this.setOutputData(2, this.getInputData(0));    
            ...
            if(this.getOutputData(0)){
                ...
                if(!message.author.cooldown.includes(this.name)){
                    await message.author.cooldown.push(this.name);
                    await setTimeout(async() => {
                            
                           
                        message.author.cooldown.splice(message.author.cooldown.indexOf(this.name),1);
